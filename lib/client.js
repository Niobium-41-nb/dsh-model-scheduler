window.__ModuleLoader__.load({
	...
	factory: (require) => {
			...
			for (const row of rows) {
				...
				rendered.push(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						className: "msd-modelFoot",
						children: [row.model.description !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "msd-modelDesc",
							title: row.model.description,
							children: row.model.description
						}) : null, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "msd-modelActions",
		...
		*/
		...
		//#endregion
		//#region src/client/use-settings-snapshot.ts
		/**
		...
		*/
		...
		function ModelSchedulerPanel({ injected, t, onClose }) {
			const config = useSettingsSnapshot(injected.scope).value ?? EMPTY_CONFIG;
			...
			*/
			const routeName = (route) => {
				if (route?.provider === void 0 || route.provider === "" || route?.model === void 0 || route.model === "") return;
				return (catalog.value?.groups ?? []).find((candidate) => candidate.id === route.provider)?.models.find((candidate) => candidate.id === route.model)?.name;
			};
			/** Whether a route carries a usable provider+model pair. */
			const routeField = (route) => route?.provider === void 0 || route.provider === "" || route?.model === void 0 || route.model === "" ? void 0 : route.model;
			/** Whether a field the panel just wrote is actually present in the stored user layer. */
			const storedMatches = (field, value) => {
				const user = injected.scope.getSnapshot().user;
				if (typeof user !== "object" || user === null || Array.isArray(user)) return false;
				return sameValue(user[field], value);
			};
			...
			const setField = (field, value) => {
				...
				injected.scope.set(String(field), value).then(() => {
					...
					setNotice(storedMatches(String(field), value) ? {
						...
						kind: "error",
						text: t("notice.rejected", { field: fieldText(field) })
					});
				}, (error) => {
					setBusy(false);
					setNotice({
			...
			const peakConfigured = routeField(config.peakModel) !== void 0;
			const offPeakConfigured = routeField(config.offPeakModel) !== void 0;
			if (view === "search") {
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "msd-statusRow",
							children: effective !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("status.effective", { model: routeName(effective) ?? routeLabelFrom(effective, t) }) }) : config.enabled === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						notice !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: notice.kind === "error" ? "msd-notice msd-notice-error" : "msd-notice msd-notice-saved",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: peakConfigured ? "msd-pickName" : "msd-pickName msd-pickEmpty",
										children: routeName(config.peakModel) ?? routeField(config.peakModel) ?? t("config.pick")
									}), routeField(config.peakModel) !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "msd-pickRoute",
										children: t("config.route", {
											provider: config.peakModel?.provider ?? "",
											model: config.peakModel?.model ?? ""
										})
									}) : null]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									className: "msd-pickText",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: offPeakConfigured ? "msd-pickName" : "msd-pickName msd-pickEmpty",
										children: routeName(config.offPeakModel) ?? routeField(config.offPeakModel) ?? t("config.pick")
									}), routeField(config.offPeakModel) !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "msd-pickRoute",
										children: t("config.route", {
											provider: config.offPeakModel?.provider ?? "",
											model: config.offPeakModel?.model ?? ""
										})
									}) : null]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "msd-pickChevron",
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: WEEKDAYS.map((day) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							onClick: () => {
								const next = days.includes(day.id) ? days.filter((existing) => existing !== day.id) : [...days, day.id].sort();
		...
		*/
		...
		function ModelSchedulerButton({ t, ...injected }) {
			...
			const period = periodAt(now, useSettingsSnapshot(injected.scope).value ?? {});
			const periodLabel = period === "peak" ? t("period.peak") : t("period.offpeak");
